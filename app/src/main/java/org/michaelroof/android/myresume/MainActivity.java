package org.michaelroof.android.myresume;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_education) {
            setTitle(getResources().getString(R.string.title_education));
            fragment = new EducationContent();

        } else if (id == R.id.nav_work_experience) {
            setTitle(getResources().getString(R.string.title_work_experience));
    ...
    protected void sendEmail() {
        ...
        String[] TO = {getResources().getString(R.string.my_email)};
